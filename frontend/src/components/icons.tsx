...
/** Generic person, for prospects — no photographs exist for them and none
 *  are coming. Drawn head-and-shoulders rather than a full silhouette so it
 *  still reads at 24px, and stroked like the rest of this file so it sits
 *  quietly beside the name instead of competing with it. */
...
/** Circular refresh arrow — the pattern everyone already reads as "fetch
 *  this again", which is the whole reason to use it instead of a labelled
 *  slab. Stroked and round-capped like the rest of this file. */
export function RefreshIcon({ className }: IconProps) {
  return (
    ...
    >
      <path
        d="M20.5 15a9 9 0 1 1-2.13-9.36L23 10"
        stroke="currentColor"
        strokeWidth="1.9"
        strokeLinecap="round"
        strokeLinejoin="round"
