...
import { LAUNCH_PARAM, markLaunched } from "@/lib/session";
...
export default function LaunchOverlay({ locatedToday, total }: Props) {
  ...
  const begin = useCallback(() => {
    ...
    // The server owns this decision from here on, so every later navigation
    // back to the scoreboard skips the opening screen.
    markLaunched();
