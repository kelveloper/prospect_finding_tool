  ...
  return (
    <div className="group relative flex items-center gap-2.5">
      ...
      <button
        type="button"
        onClick={() => {
          if (!blocked) void runIngest(false);
        }}
      ...
      {/* Source-cadence tooltip. The offset is padding, not margin: as a
          ...
          panel before the pointer could land in it. */}
      <div className="absolute right-0 top-full z-20 hidden pt-2 group-hover:block group-focus-within:block">
        <div className="w-[260px] rounded-[12px] border border-hairline bg-white p-3 shadow-panel">
          {lockedDays > 0 ? (
