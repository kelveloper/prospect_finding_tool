...
Standalone HTML pages — open them in a browser. The first two explain the
pipeline; the third is the script for presenting it live; the last two are
how the market presents prospects, and the Sources page that came out of it.
